...
export default async (req, res) => {
  try {
    if (req.method === 'POST') {
      ...
      const response = {
        is_success: true,
        user_id: "Kunal_Nigam_28122003", // Update with dynamic logic if necessary
        email: "kn4045@srmist.edu.in",        // Update with actual email
        roll_number: "RA2111029010011",       // Update with actual roll number
        numbers,
        alphabets,
